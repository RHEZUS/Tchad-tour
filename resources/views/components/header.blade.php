...
<body>
    <div>
        ...
        <nav class="navbar navbar-expand-sm navbar-light bg-light  px-1 px-md-5 w-100" style ="box-shadow: rgba(149, 157, 165, 0.2) 0px 8px 24px; position:fixed; top:0; z-index:1000; height:55px;">
            <div class="container-fluid p-0">
                <a class="navbar-brand" href="{{route('home')}}">Tchad-Tour</a>
                ...
                <div class="collapse navbar-collapse bg-light m-0 w-100" id="collapsibleNavId" >
                    <ul class="navbar-nav me-3"  style="margin-left:auto;">
                        ...
                        <li class="nav-item call-o-actiont py-2 py-sm-0">
                            <a href="#" class="call-o-actiont d-sm-none" >Giriş</a>
                        </li>
                    </ul>
                </div>
                <div class="call-o-actiont">
                    <a href="booking.php" class="call-to-action d-none d-sm-flex text-decoration-none text-white">Booking</a>
                </div>
